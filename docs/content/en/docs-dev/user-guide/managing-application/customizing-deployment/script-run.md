...
|TriggeredCommander| The name of user who triggered the deployment. This will be empty if the deployment was triggered by your piped. | username |
...
|SR_IS_ROLLBACK| This is `true` if the deployment is rollbacking. Othterwise, this is `false`. | false |
