...
| chartRegistries | [][ChartRegistry](/docs/operator-manual/piped/configuration-reference/#chartregistry) | List of helm chart registries that should be logged in while starting up. | No |
