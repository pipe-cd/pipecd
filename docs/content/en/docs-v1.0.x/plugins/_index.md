...
By default, piped deploys Kubernetes application to the cluster where the piped is running in. An external cluster can be connected by specifying the `masterURL` and `kubeConfigPath` in [`deployTargets`](../user-guide/managing-application/configuration-reference/#kubernetesplugin).
...
See [Configuration Reference for Kubernetes plugin](../user-guide/managing-application/configuration-reference/#kubernetesplugin) for complete configuration details.
...
See [Configuration Reference for Terraform plugin](../user-guide/managing-application/configuration-reference/#terraformplugin) for complete configuration details.
