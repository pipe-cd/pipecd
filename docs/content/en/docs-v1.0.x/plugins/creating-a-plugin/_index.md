...
This tutorial is adapted from warashi's Zenn book, [作って学ぶ PipeCD プラグイン (Try and Learn PipeCD Plugin)](https://zenn.dev/warashi/books/try-and-learn-pipecd-plugin). It walks through the same example plugin, with the code updated here for the current PipeCD plugin SDK.
