...
> **Note**: This feature is at the alpha status. Currently you can use it on all application kinds, but the rollback feature is only for applications using the Kubernetes Plugin.
...
![Script Run onRollback](/images/script-run-onRollback.png)
