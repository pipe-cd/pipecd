...
After a new deployment was triggered, it will be queued to be handled by the appropriate `piped`. And at this time the deployment pipeline was not decided yet.
