...
gen/code:
	...
	docker run --rm -v ${PWD}:/repo -it --entrypoint ./tool/codegen/codegen.sh ghcr.io/pipe-cd/codegen@sha256:91aac0a0caeaee8fc6836108a8907db0b879e8e65af823313dac6b9bc845bfd3 /repo #v0.36.0-17-g496e959
