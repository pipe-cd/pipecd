...
gen/code:
	...
	docker run --rm -v ${PWD}:/repo -it --entrypoint ./tool/codegen/codegen.sh ghcr.io/pipe-cd/codegen@sha256:9cb61b98dc33691ffbafdef0c658121474645a93d03c56f4775b625b34604b1d /repo #v0.37.0-5-gf5c7d5c
