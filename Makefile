...
gen/code:
	...
	docker run --rm -v ${PWD}:/repo -it --entrypoint ./tool/codegen/codegen.sh ghcr.io/pipe-cd/codegen@sha256:6a22e030dd4306da26ef4437f78f8e0ecd39ac4c6cf51a0587fbd73fe81c6417 /repo #v0.36.0-20-gf1a1dd6
