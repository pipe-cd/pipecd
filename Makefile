...
gen/code:
	...
	docker run --rm -v ${PWD}:/repo -it --entrypoint ./tool/codegen/codegen.sh ghcr.io/pipe-cd/codegen@sha256:c246a6a9c10c693684bee8f441706b4dd6796f50dc87a3d4838ef7003b7d73f7 /repo #v0.41.0-47-gd2cb87b
