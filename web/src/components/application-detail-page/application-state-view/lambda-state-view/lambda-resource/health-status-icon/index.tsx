...
import { HealthStatus } from "~/types/applications-live-state";

export interface LambdaResourceHealthStatusIconProps {
  health: HealthStatus;
}

export const LambdaResourceHealthStatusIcon: FC<LambdaResourceHealthStatusIconProps> = memo(
