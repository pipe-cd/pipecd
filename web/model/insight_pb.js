...
goog.exportSymbol('proto.model.InsightDeploymentChunkMetaData.InsightChunkData', null, global);
 ...
 * @constructor
 */
proto.model.InsightDeploymentChunkMetaData.InsightChunkData = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.model.InsightDeploymentChunkMetaData.InsightChunkData, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.model.InsightDeploymentChunkMetaData.InsightChunkData.displayName = 'proto.model.InsightDeploymentChunkMetaData.InsightChunkData';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {string}
 */
proto.model.InsightDeploymentSubset.prototype.getId = function() {
 ...
 */
proto.model.InsightDeploymentSubset.prototype.setId = function(value) {
...
proto.model.InsightDeploymentChunkMetaData.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.model.InsightDeploymentChunkMetaData.InsightChunkData.toObject, includeInstance)
  };
...
proto.model.InsightDeploymentChunkMetaData.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.model.InsightDeploymentChunkMetaData.InsightChunkData;
      reader.readMessage(value,proto.model.InsightDeploymentChunkMetaData.InsightChunkData.deserializeBinaryFromReader);
      msg.addData(value);
      break;
    default:
      reader.skipField();
...
proto.model.InsightDeploymentChunkMetaData.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.model.InsightDeploymentChunkMetaData.InsightChunkData.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.model.InsightDeploymentChunkMetaData.InsightChunkData.prototype.toObject = function(opt_includeInstance) {
  return proto.model.InsightDeploymentChunkMetaData.InsightChunkData.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.model.InsightDeploymentChunkMetaData.InsightChunkData} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.model.InsightDeploymentChunkMetaData.InsightChunkData.toObject = function(includeInstance, msg) {
  var f, obj = {
    dateRange: (f = msg.getDateRange()) && proto.model.InsightChunkDateRange.toObject(includeInstance, f),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.model.InsightDeploymentChunkMetaData.InsightChunkData}
 */
proto.model.InsightDeploymentChunkMetaData.InsightChunkData.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.model.InsightDeploymentChunkMetaData.InsightChunkData;
  return proto.model.InsightDeploymentChunkMetaData.InsightChunkData.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.model.InsightDeploymentChunkMetaData.InsightChunkData} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.model.InsightDeploymentChunkMetaData.InsightChunkData}
 */
proto.model.InsightDeploymentChunkMetaData.InsightChunkData.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.model.InsightDeploymentChunkMetaData.InsightChunkData.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.model.InsightDeploymentChunkMetaData.InsightChunkData.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.model.InsightDeploymentChunkMetaData.InsightChunkData} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.model.InsightDeploymentChunkMetaData.InsightChunkData.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDateRange();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.model.InsightChunkDateRange}
 */
proto.model.InsightDeploymentChunkMetaData.InsightChunkData.prototype.getDateRange = function() {
  return /** @type{?proto.model.InsightChunkDateRange} */ (
    jspb.Message.getWrapperField(this, proto.model.InsightChunkDateRange, 1));
};
...
/**
 * @param {?proto.model.InsightChunkDateRange|undefined} value
 * @return {!proto.model.InsightDeploymentChunkMetaData.InsightChunkData} returns this
*/
proto.model.InsightDeploymentChunkMetaData.InsightChunkData.prototype.setDateRange = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.model.InsightDeploymentChunkMetaData.InsightChunkData} returns this
 */
proto.model.InsightDeploymentChunkMetaData.InsightChunkData.prototype.clearDateRange = function() {
  return this.setDateRange(undefined);
};
 ...
 * @return {boolean}
 */
proto.model.InsightDeploymentChunkMetaData.InsightChunkData.prototype.hasDateRange = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {string}
 */
proto.model.InsightDeploymentChunkMetaData.InsightChunkData.prototype.getChunkKey = function() {
 ...
 * @return {!proto.model.InsightDeploymentChunkMetaData.InsightChunkData} returns this
 */
proto.model.InsightDeploymentChunkMetaData.InsightChunkData.prototype.setChunkKey = function(value) {
 ...
 * @return {number}
 */
proto.model.InsightDeploymentChunkMetaData.InsightChunkData.prototype.getChunkSize = function() {
 ...
 * @return {!proto.model.InsightDeploymentChunkMetaData.InsightChunkData} returns this
 */
proto.model.InsightDeploymentChunkMetaData.InsightChunkData.prototype.setChunkSize = function(value) {
 ...
 * @return {!Array<!proto.model.InsightDeploymentChunkMetaData.InsightChunkData>}
 */
proto.model.InsightDeploymentChunkMetaData.prototype.getDataList = function() {
  return /** @type{!Array<!proto.model.InsightDeploymentChunkMetaData.InsightChunkData>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.model.InsightDeploymentChunkMetaData.InsightChunkData, 1));
};


/**
 * @param {!Array<!proto.model.InsightDeploymentChunkMetaData.InsightChunkData>} value
...
/**
 * @param {!proto.model.InsightDeploymentChunkMetaData.InsightChunkData=} opt_value
 * @param {number=} opt_index
 * @return {!proto.model.InsightDeploymentChunkMetaData.InsightChunkData}
 */
proto.model.InsightDeploymentChunkMetaData.prototype.addData = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.model.InsightDeploymentChunkMetaData.InsightChunkData, opt_index);
};
