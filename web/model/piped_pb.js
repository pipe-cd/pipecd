...
goog.exportSymbol('proto.model.Piped.Plugin', null, global);
 ...
 * @constructor
 */
proto.model.Piped.Plugin = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.model.Piped.Plugin.repeatedFields_, null);
};
goog.inherits(proto.model.Piped.Plugin, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.model.Piped.Plugin.displayName = 'proto.model.Piped.Plugin';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.model.Piped.repeatedFields_ = [9,10,16,17,20];
...
proto.model.Piped.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.model.Piped.Plugin.toObject, includeInstance),
...
proto.model.Piped.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 16:
      ...
      break;
    case 17:
      var value = new proto.model.Piped.Plugin;
      reader.readMessage(value,proto.model.Piped.Plugin.deserializeBinaryFromReader);
...
proto.model.Piped.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      17,
      f,
      proto.model.Piped.Plugin.serializeBinaryToWriter
    );
  }
 ...
 * @const
 */
proto.model.Piped.Plugin.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.model.Piped.Plugin.prototype.toObject = function(opt_includeInstance) {
  return proto.model.Piped.Plugin.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.model.Piped.Plugin} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.model.Piped.Plugin.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: jspb.Message.getFieldWithDefault(msg, 1, ""),
    deployTargetsList: (f = jspb.Message.getRepeatedField(msg, 2)) == null ? undefined : f
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.model.Piped.Plugin}
 */
proto.model.Piped.Plugin.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.model.Piped.Plugin;
  return proto.model.Piped.Plugin.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.model.Piped.Plugin} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.model.Piped.Plugin}
 */
proto.model.Piped.Plugin.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.model.Piped.Plugin.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.model.Piped.Plugin.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.model.Piped.Plugin} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.model.Piped.Plugin.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.model.Piped.Plugin.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.model.Piped.Plugin} returns this
 */
proto.model.Piped.Plugin.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!Array<string>}
 */
proto.model.Piped.Plugin.prototype.getDeployTargetsList = function() {
 ...
 * @return {!proto.model.Piped.Plugin} returns this
 */
proto.model.Piped.Plugin.prototype.setDeployTargetsList = function(value) {
 ...
 * @return {!proto.model.Piped.Plugin} returns this
 */
proto.model.Piped.Plugin.prototype.addDeployTargets = function(value, opt_index) {
 ...
 * @return {!proto.model.Piped.Plugin} returns this
 */
proto.model.Piped.Plugin.prototype.clearDeployTargetsList = function() {
 ...
 * @return {!Array<!proto.model.Piped.Plugin>}
 */
proto.model.Piped.prototype.getPluginsList = function() {
  return /** @type{!Array<!proto.model.Piped.Plugin>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.model.Piped.Plugin, 17));
};


/**
 * @param {!Array<!proto.model.Piped.Plugin>} value
 * @return {!proto.model.Piped} returns this
*/
proto.model.Piped.prototype.setPluginsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 17, value);
};


/**
 * @param {!proto.model.Piped.Plugin=} opt_value
 * @param {number=} opt_index
 * @return {!proto.model.Piped.Plugin}
 */
proto.model.Piped.prototype.addPlugins = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 17, opt_value, proto.model.Piped.Plugin, opt_index);
};
 ...
 * @return {!proto.model.Piped} returns this
 */
proto.model.Piped.prototype.clearPluginsList = function() {
