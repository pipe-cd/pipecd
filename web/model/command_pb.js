...
proto.model.Command.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    statusReason: jspb.Message.getFieldWithDefault(msg, 23, ""),
...
/**
 * optional string status_reason = 23;
 * @return {string}
 */
proto.model.Command.prototype.getStatusReason = function() {
 ...
 * @return {!proto.model.Command} returns this
 */
proto.model.Command.prototype.setStatusReason = function(value) {
