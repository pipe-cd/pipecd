...
goog.exportSymbol('proto.model.KeyValues', null, global);
 ...
 * @constructor
 */
proto.model.KeyValues = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.model.KeyValues, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.model.KeyValues.displayName = 'proto.model.KeyValues';
}
...
proto.model.Deployment.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    pluginMetadataMap: (f = msg.getPluginMetadataMap()) ? f.toObject(includeInstance, proto.model.KeyValues.toObject) : [],
...
proto.model.Deployment.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 33:
      ...
      break;
    case 34:
      var value = msg.getPluginMetadataMap();
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.model.KeyValues.deserializeBinaryFromReader, "", new proto.model.KeyValues());
         });
      break;
    case 40:
      var value = /** @type {string} */ (reader.readString());
...
proto.model.Deployment.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getPluginMetadataMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(34, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.model.KeyValues.serializeBinaryToWriter);
  }
...
/**
 * map<string, KeyValues> plugin_metadata = 34;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.model.KeyValues>}
 */
proto.model.Deployment.prototype.getPluginMetadataMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.model.KeyValues>} */ (
      jspb.Message.getMapField(this, 34, opt_noLazyCreate,
      proto.model.KeyValues));
};
 ...
 * @return {!proto.model.Deployment} returns this
 */
proto.model.Deployment.prototype.clearPluginMetadataMap = function() {
  this.getPluginMetadataMap().clear();
  return this;
};
 ...
 * @return {!Object}
 */
proto.model.KeyValues.prototype.toObject = function(opt_includeInstance) {
  return proto.model.KeyValues.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.model.KeyValues} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.model.KeyValues.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.model.KeyValues}
 */
proto.model.KeyValues.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.model.KeyValues;
  return proto.model.KeyValues.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.model.KeyValues} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.model.KeyValues}
 */
proto.model.KeyValues.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.model.KeyValues.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.model.KeyValues.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.model.KeyValues} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.model.KeyValues.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!jspb.Map<string,string>}
 */
proto.model.KeyValues.prototype.getKeyvaluesMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,string>} */ (
...
/**
 * Clears values from the map. The map will be non-null.
 * @return {!proto.model.KeyValues} returns this
 */
proto.model.KeyValues.prototype.clearKeyvaluesMap = function() {
