...
import (
	...
	scheme "github.com/kapetaniosci/pipe/pkg/crd/client/clientset/versioned/scheme"
...
type PipelineInterface interface {
	...
	UpdateStatus(ctx context.Context, pipeline *v1beta1.Pipeline, opts v1.UpdateOptions) (*v1beta1.Pipeline, error)
...
func newPipelines(c *PipecdV1beta1Client, namespace string) *pipelines {
	return &pipelines{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *pipelines) UpdateStatus(ctx context.Context, pipeline *v1beta1.Pipeline, opts v1.UpdateOptions) (result *v1beta1.Pipeline, err error) {
	result = &v1beta1.Pipeline{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pipelines").
