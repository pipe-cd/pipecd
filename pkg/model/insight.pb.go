...
type InsightDailyDeployment struct {
	...
	// Daily InsightDeploymentSubset sorted by created_at ASC.
	...
	// Unix time when the insight daily deployment is created.
	CreatedAt int64 `protobuf:"varint,14,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	// Unix time of the last time when the insight daily deployment is updated.
	UpdatedAt int64 `protobuf:"varint,15,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"`
}
...
type InsightDeploymentChunk struct {
	...
	// Daily-deployments sorted by InsightDailyDeployment.date ASC.
...
type InsightDeploymentChunkMetaData struct {
	...
	Data []*InsightDeploymentChunkMetaData_ChunkData `protobuf:"bytes,1,rep,name=data,proto3" json:"data,omitempty"`
}
...
func (x *InsightDeploymentChunkMetaData) GetData() []*InsightDeploymentChunkMetaData_ChunkData {
	if x != nil {
		return x.Data
	}
	return nil
...
type InsightDeploymentChunkMetaData_ChunkData struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *InsightDeploymentChunkMetaData_ChunkData) Reset() {
	*x = InsightDeploymentChunkMetaData_ChunkData{}
	if protoimpl.UnsafeEnabled {
...
func (x *InsightDeploymentChunkMetaData_ChunkData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InsightDeploymentChunkMetaData_ChunkData) ProtoMessage() {}

func (x *InsightDeploymentChunkMetaData_ChunkData) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_model_insight_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InsightDeploymentChunkMetaData_ChunkData.ProtoReflect.Descriptor instead.
func (*InsightDeploymentChunkMetaData_ChunkData) Descriptor() ([]byte, []int) {
	return file_pkg_model_insight_proto_rawDescGZIP(), []int{7, 0}
}

func (x *InsightDeploymentChunkMetaData_ChunkData) GetDateRange() *InsightChunkDateRange {
	if x != nil {
		return x.DateRange
	}
	return nil
...
func (x *InsightDeploymentChunkMetaData_ChunkData) GetChunkKey() string {
	if x != nil {
		return x.ChunkKey
	}
	return ""
...
func (x *InsightDeploymentChunkMetaData_ChunkData) GetChunkSize() int64 {
	if x != nil {
		return x.ChunkSize
	}
	return 0
...
var file_pkg_model_insight_proto_rawDesc = []byte{
	...
	0x02, 0x38, 0x01, 0x22, 0x69, 0x0a, 0x17, 0x49, 0x6e, 0x73, 0x69, 0x67, 0x68, 0x74, 0x44, 0x65,
	0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x53, 0x75, 0x62, 0x73, 0x65, 0x74, 0x12, 0x26,
	...
	,
	...
	,
	...
	,
...
var file_pkg_model_insight_proto_goTypes = []interface{}{
	...
	(*InsightDeploymentChunkMetaData_ChunkData)(nil), // 15: model.InsightDeploymentChunkMetaData.ChunkData
}
var file_pkg_model_insight_proto_depIdxs = []int32{
	...
	15, // 8: model.InsightDeploymentChunkMetaData.data:type_name -> model.InsightDeploymentChunkMetaData.ChunkData
	11, // 9: model.InsightDeploymentChunkMetaData.ChunkData.date_range:type_name -> model.InsightChunkDateRange
...
func file_pkg_model_insight_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_model_insight_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InsightDeploymentChunkMetaData_ChunkData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
