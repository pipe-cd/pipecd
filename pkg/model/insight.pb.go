...
type InsightDeploymentSubset struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *InsightDeploymentSubset) Reset() {
	*x = InsightDeploymentSubset{}
	if protoimpl.UnsafeEnabled {
...
func (x *InsightDeploymentSubset) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InsightDeploymentSubset) ProtoMessage() {}

func (x *InsightDeploymentSubset) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_model_insight_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InsightDeploymentSubset.ProtoReflect.Descriptor instead.
func (*InsightDeploymentSubset) Descriptor() ([]byte, []int) {
	return file_pkg_model_insight_proto_rawDescGZIP(), []int{4}
}

func (x *InsightDeploymentSubset) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *InsightDeploymentSubset) GetCreatedAt() int64 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *InsightDeploymentSubset) GetUpdatedAt() int64 {
	if x != nil {
		return x.UpdatedAt
	}
	return 0
...
type InsightDailyDeployment struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	DailyDeployments []*InsightDeploymentSubset `protobuf:"bytes,4,rep,name=daily_deployments,json=dailyDeployments,proto3" json:"daily_deployments,omitempty"`
}

func (x *InsightDailyDeployment) Reset() {
	*x = InsightDailyDeployment{}
	if protoimpl.UnsafeEnabled {
...
func (x *InsightDailyDeployment) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InsightDailyDeployment) ProtoMessage() {}

func (x *InsightDailyDeployment) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_model_insight_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InsightDailyDeployment.ProtoReflect.Descriptor instead.
func (*InsightDailyDeployment) Descriptor() ([]byte, []int) {
	return file_pkg_model_insight_proto_rawDescGZIP(), []int{5}
}

func (x *InsightDailyDeployment) GetDate() int64 {
	if x != nil {
		return x.Date
	}
	return 0
...
func (x *InsightDailyDeployment) GetCreatedAt() int64 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *InsightDailyDeployment) GetUpdatedAt() int64 {
	if x != nil {
		return x.UpdatedAt
	}
	return 0
...
func (x *InsightDailyDeployment) GetDailyDeployments() []*InsightDeploymentSubset {
	if x != nil {
...
type InsightDeploymentChunk struct {
	...
	DateRange *InsightChunkDateRange `protobuf:"bytes,1,opt,name=date_range,json=dateRange,proto3" json:"date_range,omitempty"`
	// `deployments` sorted by DailyDeployment.date ASC.
	Deployments []*InsightDailyDeployment `protobuf:"bytes,2,rep,name=deployments,proto3" json:"deployments,omitempty"`
}
...
func (x *InsightDeploymentChunk) GetDateRange() *InsightChunkDateRange {
	if x != nil {
		return x.DateRange
	}
	return nil
...
func (x *InsightDeploymentChunk) GetDeployments() []*InsightDailyDeployment {
	if x != nil {
...
type InsightDeploymentChunkMetaData struct {
	...
	Data []*InsightDeploymentChunkMetaData_InsightChunkData `protobuf:"bytes,1,rep,name=data,proto3" json:"data,omitempty"`
}
...
func (x *InsightDeploymentChunkMetaData) GetData() []*InsightDeploymentChunkMetaData_InsightChunkData {
	if x != nil {
		return x.Data
	}
	return nil
...
type InsightChunkDateRange struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *InsightChunkDateRange) Reset() {
	*x = InsightChunkDateRange{}
	if protoimpl.UnsafeEnabled {
...
func (x *InsightChunkDateRange) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InsightChunkDateRange) ProtoMessage() {}

func (x *InsightChunkDateRange) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_model_insight_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InsightChunkDateRange.ProtoReflect.Descriptor instead.
func (*InsightChunkDateRange) Descriptor() ([]byte, []int) {
	return file_pkg_model_insight_proto_rawDescGZIP(), []int{8}
}

func (x *InsightChunkDateRange) GetFrom() int64 {
	if x != nil {
		return x.From
	}
	return 0
...
func (x *InsightChunkDateRange) GetTo() int64 {
	if x != nil {
		return x.To
	}
	return 0
...
type InsightDeploymentChunkMetaData_InsightChunkData struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *InsightDeploymentChunkMetaData_InsightChunkData) Reset() {
	*x = InsightDeploymentChunkMetaData_InsightChunkData{}
	if protoimpl.UnsafeEnabled {
...
func (x *InsightDeploymentChunkMetaData_InsightChunkData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InsightDeploymentChunkMetaData_InsightChunkData) ProtoMessage() {}

func (x *InsightDeploymentChunkMetaData_InsightChunkData) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_model_insight_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InsightDeploymentChunkMetaData_InsightChunkData.ProtoReflect.Descriptor instead.
func (*InsightDeploymentChunkMetaData_InsightChunkData) Descriptor() ([]byte, []int) {
	return file_pkg_model_insight_proto_rawDescGZIP(), []int{7, 0}
}

func (x *InsightDeploymentChunkMetaData_InsightChunkData) GetDateRange() *InsightChunkDateRange {
	if x != nil {
		return x.DateRange
	}
	return nil
...
func (x *InsightDeploymentChunkMetaData_InsightChunkData) GetChunkKey() string {
	if x != nil {
		return x.ChunkKey
	}
	return ""
...
func (x *InsightDeploymentChunkMetaData_InsightChunkData) GetChunkSize() int64 {
	if x != nil {
		return x.ChunkSize
	}
	return 0
...
var file_pkg_model_insight_proto_rawDesc = []byte{
	...
	0x02, 0x38, 0x01, 0x22, 0x82, 0x01, 0x0a, 0x17, 0x49, 0x6e, 0x73, 0x69, 0x67, 0x68, 0x74, 0x44,
	0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x53, 0x75, 0x62, 0x73, 0x65, 0x74, 0x12,
	0x17, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x07, 0xfa, 0x42, 0x04,
	0x72, 0x02, 0x10, 0x01, 0x52, 0x02, 0x69, 0x64, 0x12, 0x26, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x61,
	...
	0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xd2, 0x01, 0x0a, 0x16, 0x49, 0x6e, 0x73,
	0x69, 0x67, 0x68, 0x74, 0x44, 0x61, 0x69, 0x6c, 0x79, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d,
	0x65, 0x6e, 0x74, 0x12, 0x1b, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x03, 0x42, 0x07, 0xfa, 0x42, 0x04, 0x22, 0x02, 0x28, 0x00, 0x52, 0x04, 0x64, 0x61, 0x74, 0x65,
	...
	,
	...
	,
...
var file_pkg_model_insight_proto_goTypes = []interface{}{
	...
	(*InsightDeploymentSubset)(nil),        // 7: model.InsightDeploymentSubset
	(*InsightDailyDeployment)(nil),         // 8: model.InsightDailyDeployment
	(*InsightDeploymentChunk)(nil),         // 9: model.InsightDeploymentChunk
	(*InsightDeploymentChunkMetaData)(nil), // 10: model.InsightDeploymentChunkMetaData
	(*InsightChunkDateRange)(nil),          // 11: model.InsightChunkDateRange
	...
	(*InsightDeploymentChunkMetaData_InsightChunkData)(nil), // 15: model.InsightDeploymentChunkMetaData.InsightChunkData
}
var file_pkg_model_insight_proto_depIdxs = []int32{
	...
	7,  // 5: model.InsightDailyDeployment.daily_deployments:type_name -> model.InsightDeploymentSubset
	11, // 6: model.InsightDeploymentChunk.date_range:type_name -> model.InsightChunkDateRange
	8,  // 7: model.InsightDeploymentChunk.deployments:type_name -> model.InsightDailyDeployment
	15, // 8: model.InsightDeploymentChunkMetaData.data:type_name -> model.InsightDeploymentChunkMetaData.InsightChunkData
	11, // 9: model.InsightDeploymentChunkMetaData.InsightChunkData.date_range:type_name -> model.InsightChunkDateRange
...
func file_pkg_model_insight_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_model_insight_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InsightDeploymentSubset); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pkg_model_insight_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InsightDailyDeployment); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pkg_model_insight_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InsightChunkDateRange); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pkg_model_insight_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InsightDeploymentChunkMetaData_InsightChunkData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
