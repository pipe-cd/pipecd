...
type LogBlocks struct {
	...
	Logblocks []*LogBlock `protobuf:"bytes,1,rep,name=logblocks,proto3" json:"logblocks,omitempty"`
}

func (x *LogBlocks) Reset() {
	*x = LogBlocks{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_model_logblock_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *LogBlocks) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LogBlocks) ProtoMessage() {}

func (x *LogBlocks) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_model_logblock_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LogBlocks.ProtoReflect.Descriptor instead.
func (*LogBlocks) Descriptor() ([]byte, []int) {
	return file_pkg_model_logblock_proto_rawDescGZIP(), []int{1}
}

func (x *LogBlocks) GetLogblocks() []*LogBlock {
	if x != nil {
		return x.Logblocks
	}
	return nil
...
var file_pkg_model_logblock_proto_rawDesc = []byte{
	...
	0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x3a, 0x0a, 0x09, 0x4c, 0x6f,
	0x67, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x12, 0x2d, 0x0a, 0x09, 0x6c, 0x6f, 0x67, 0x62, 0x6c,
	0x6f, 0x63, 0x6b, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x6d, 0x6f, 0x64,
	0x65, 0x6c, 0x2e, 0x4c, 0x6f, 0x67, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x09, 0x6c, 0x6f, 0x67,
	0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x2a, 0x2f, 0x0a, 0x0b, 0x4c, 0x6f, 0x67, 0x53, 0x65, 0x76,
	...
	0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x02, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x68, 0x75,
...
func file_pkg_model_logblock_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_model_logblock_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LogBlocks); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
