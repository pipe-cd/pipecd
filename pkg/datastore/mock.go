...
//
//	mockgen -source=pkg/datastore/datastore.go -destination=pkg/datastore/mock.go -package=datastore
//
...
func (m *MockDataStore) Create(ctx context.Context, col Collection, id string, entity any) error {
	m.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) Create(ctx, col, id, entity any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) Find(ctx, col, opts any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Find", reflect.TypeOf((*MockDataStore)(nil).Find), ctx, col, opts)
}

// Get mocks base method.
func (m *MockDataStore) Get(ctx context.Context, col Collection, id string, entity any) error {
	m.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) Get(ctx, col, id, entity any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) Update(ctx, col, id, updater any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
