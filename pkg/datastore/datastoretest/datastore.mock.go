...
func (m *MockApplicationStore) UpdateConfiguration(ctx context.Context, id, pipedID, platformProvider, configFilename string, dpt map[string]*structpb.ListValue) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateConfiguration", ctx, id, pipedID, platformProvider, configFilename, dpt)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateConfiguration indicates an expected call of UpdateConfiguration.
func (mr *MockApplicationStoreMockRecorder) UpdateConfiguration(ctx, id, pipedID, platformProvider, configFilename, dpt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateConfiguration", reflect.TypeOf((*MockApplicationStore)(nil).UpdateConfiguration), ctx, id, pipedID, platformProvider, configFilename, dpt)
}
