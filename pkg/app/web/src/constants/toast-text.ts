...
export const DELETE_OLD_PIPED_KEY_SUCCESS = "Successfully deleted old Piped key.";
export const UPGRADE_PIPEDS_SUCCESS = "Successfully requested to upgrade Pipeds.";
