...
// Source: github.com/pipe-cd/pipecd/pkg/app/pipedv1/plugin/kubernetes/provider (interfaces: Applier,Loader)
...
import (
	...
	provider "github.com/pipe-cd/pipecd/pkg/app/pipedv1/plugin/kubernetes/provider"
)
...
func (m *MockApplier) ApplyManifest(arg0 context.Context, arg1 provider.Manifest) error {
	m.ctrl.T.Helper()
...
func (m *MockApplier) CreateManifest(arg0 context.Context, arg1 provider.Manifest) error {
	m.ctrl.T.Helper()
...
func (m *MockApplier) Delete(arg0 context.Context, arg1 provider.ResourceKey) error {
	m.ctrl.T.Helper()
...
func (m *MockApplier) ForceReplaceManifest(arg0 context.Context, arg1 provider.Manifest) error {
	m.ctrl.T.Helper()
...
func (m *MockApplier) ReplaceManifest(arg0 context.Context, arg1 provider.Manifest) error {
	m.ctrl.T.Helper()
...
func (m *MockLoader) LoadManifests(arg0 context.Context) ([]provider.Manifest, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LoadManifests", arg0)
	ret0, _ := ret[0].([]provider.Manifest)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
